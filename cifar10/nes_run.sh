...
python3 hybrid_attack.py -n 100 --attack_method nes --attack_type targeted --model_type normal --local_model_names no_local_model

# nes targeted hybrid attack on normal target model with normal local models
python3 hybrid_attack.py -n 100 --load_imgs --with_local --no_tune_local --attack_method nes --attack_type targeted --model_type normal --local_model_names modelB modelD modelE

# nes targeted hybrid attack on normal target model with robust local models
python3 hybrid_attack.py -n 100 --load_imgs --with_local --no_tune_local --attack_method nes --attack_type targeted --model_type normal --local_model_names adv_densenet adv_resnet

# nes targeted hybrid attack (with local model tuning) on normal target model with normal local models
python3 hybrid_attack.py -n 100 --load_imgs --with_local --attack_method nes --attack_type targeted --model_type normal --local_model_names modelB modelD modelE
